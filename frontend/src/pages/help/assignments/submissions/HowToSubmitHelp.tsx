    ...
    extra: (
      <Card className="mt-4" size="small" title="Quick facts" bordered>
        <ul className="list-disc pl-5">
          <li>
            Submit from the assignment page via the <b>Submit</b> button (top-right).
          </li>
  ...
  return (
    <Space direction="vertical" size="small" className="w-full !p-0">
      ...
      <Paragraph className="mb-0">
        Uploading creates a new attempt that Fitchfork unpacks, builds, and runs using the
        assignment’s Main/Makefile or interpreter. Outputs per task are diffed against Memo Output,
        then marks and feedback appear on the assignment page. Follow the archive rules below so
        your submission passes validation and runs cleanly on the grader.
      </Paragraph>
      ...
      <ul className="list-disc pl-5">
        <li>
          <b>Include every required source file</b> so the grader can build and run.
        </li>
        <li>
          <b>Flatten the archive</b> — no nested directories; files go at the root.
        </li>
        <li>
          <b>Match the expected entry file</b> (e.g., <Text code>Main.java</Text> or{' '}
          <Text code>Main.cpp</Text>).
        </li>
        <li>
          <b>Exclude binaries and large data</b> to keep uploads small and clean.
        </li>
        <li>
          <b>Prefer deterministic output</b> (avoid timestamps/random logs) if marking compares
          text.
        </li>
      </ul>
      ...
      <Paragraph className="mb-2">
        Submit a single archive (recommended: <Text code>.zip</Text>). Place required files at the{' '}
        <b>root</b> and avoid nested folders so the grader can extract them directly.
      </Paragraph>
      <Card>
        <CodeEditor
      ...
      <ol className="list-decimal pl-5">
        ...
        <li>
          Drag and drop your archive (e.g., <Text code>submission.zip</Text>) into the modal.
        </li>
        <li>Confirm the honour code checkbox if prompted.</li>
        <li>
          Click <b>Submit</b>. The attempt is queued, built, and run; results appear once processing
          finishes.
        </li>
      </ol>
      <Alert
      ...
      <Descriptions bordered size="middle" column={1} className="mt-2">
        <Descriptions.Item label="Status">
          Submissions are queued, built, and run under the assignment’s execution limits. Progress
          appears on the assignment page.
        </Descriptions.Item>
        <Descriptions.Item label="Results">
          View output, marks, and feedback once processing completes. The run history shows each
          attempt.
        </Descriptions.Item>
        <Descriptions.Item label="Resubmissions">
          If resubmissions are allowed, the assignment’s policy (e.g., “best” or “last”) decides
          which attempt counts toward your mark.
        </Descriptions.Item>
      </Descriptions>
