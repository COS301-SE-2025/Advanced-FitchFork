...
export const ModulesService = {
   ...
   */
  getLecturers: (moduleId: number): Promise<ApiResponse<ListLecturersResponse>> =>
   ...
   */
  getTutors: (moduleId: number): Promise<ApiResponse<ListTutorsResponse>> =>
   ...
   */
  getStudents: (moduleId: number): Promise<ApiResponse<ListStudentsResponse>> =>
