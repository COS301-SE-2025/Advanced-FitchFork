...
impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m202506030030_create_assignment_memo_outputs"
    }
}
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .create_table(
                Table::create()
                    .table(Alias::new("assignment_memo_outputs"))
                    .if_not_exists()
                    .col(
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .from(
                                Alias::new("assignment_memo_outputs"),
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .from(Alias::new("assignment_memo_outputs"), Alias::new("task_id"))
