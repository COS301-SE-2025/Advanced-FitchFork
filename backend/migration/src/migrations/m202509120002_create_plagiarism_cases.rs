        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(Alias::new("submission_id_1"))
                            .big_integer()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(Alias::new("submission_id_2"))
                            .big_integer()
                            .not_null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(Alias::new("similarity"))
                            .float()
                            .not_null()
                            .default(0.0),
                    )
                    .col(
                        ColumnDef::new(Alias::new("lines_matched"))
                            .integer()
                            .not_null()
                            .default(0),
                    )
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            ...
                            .from(
                                Alias::new("plagiarism_cases"),
                                Alias::new("submission_id_1"),
                            )
