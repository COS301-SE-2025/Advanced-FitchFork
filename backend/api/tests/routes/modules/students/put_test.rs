...
mod tests {
    ...
    async fn setup_test_data(db: &sea_orm::DatabaseConnection) -> TestData {
        let module = ModuleModel::create(db, "COS401", 2024, Some("Test Module"), 16).await.unwrap();
        ...
        let tutor1 = UserModel::create(db, "tutor1", "tutor1@test.com", "password3", false).await.unwrap();
