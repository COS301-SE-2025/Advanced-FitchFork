...
mod tests {
    ...
    async fn assign_personnel_as_admin_success() {
        ...
        let _ = axum::body::to_bytes(res.into_body(), 1024 * 1024)
            .await
            .unwrap(); // consume body for completeness
    ...
    async fn assign_personnel_as_lecturer_success_for_non_lecturer_roles() {
        ...
        let req = Request::builder()
            ...
            .header("Content-Type", "application/json")
            .body(Body::from(
                json!({ "user_ids": [data.outsider.id], "role": "assistant_lecturer" }).to_string(),
            ))
            .unwrap();
    ...
    async fn assign_lecturer_role_as_lecturer_forbidden() {
        ...
        let req = Request::builder()
            ...
            .header("Content-Type", "application/json")
            .body(Body::from(
                json!({ "user_ids": [data.outsider.id], "role": "lecturer" }).to_string(),
            ))
            .unwrap();
    ...
    async fn assign_personnel_as_non_lecturer_forbidden() {
        ...
        let req = Request::builder()
            ...
            .header("Content-Type", "application/json")
            .body(Body::from(
                json!({ "user_ids": [data.lecturer.id], "role": "tutor" }).to_string(),
            ))
            .unwrap();
    ...
    async fn assign_personnel_as_student_forbidden() {
        ...
        let req = Request::builder()
            ...
            .header("Content-Type", "application/json")
            .body(Body::from(
                json!({ "user_ids": [data.outsider.id], "role": "tutor" }).to_string(),
            ))
            .unwrap();
    ...
    async fn assign_personnel_user_not_found() {
        ...
        let req = Request::builder()
            ...
            .header("Content-Type", "application/json")
            .body(Body::from(
                json!({ "user_ids": [9999999], "role": "student" }).to_string(),
            ))
            .unwrap();
    ...
    async fn assign_personnel_empty_user_ids() {
        ...
        let req = Request::builder()
            ...
            .header("Content-Type", "application/json")
            .body(Body::from(
                json!({ "user_ids": [], "role": "student" }).to_string(),
            ))
            .unwrap();
