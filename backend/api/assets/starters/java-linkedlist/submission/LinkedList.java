...
public class LinkedList {
	...
	// also provide empty() for broader compatibility
	...
	public boolean popFront(IntBox out) {
		...
		head = head.next;
		// BUG (intentional): if head becomes null, tail should be null (not done)
		size--;
		return true;
	}
	...
	public boolean erase(int index) {
		...
		// BUG (intentional): if removing last element, tail should become prev (not
		// done)
		size--;
		return true;
	}
