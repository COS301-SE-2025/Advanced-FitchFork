...
use chrono::Utc;
use db::{
    models::announcements::{ActiveModel, Column, Entity},
...
impl<'a> Service<'a, Entity, Column, CreateAnnouncement, UpdateAnnouncement>
    for AnnouncementService
{
